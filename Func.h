...
const int SCREEN_WIDTH = 1024 ;           //kich co man hinh
...
const int PLAY_BUTTON_X = 393;      //vi tri nut Play
const int PLAY_BUTTON_Y= 220;
const int HELP_BUTTON_X = 393;      //vi tri nut help
const int HELP_BUTTON_Y = 340;
const int EXIT_BUTTON_X = 393;      //vi tri nut exit
const int EXIT_BUTTON_Y = 450;
...
const int WIDTHPOS = 955;

const int TEXT_1_X = 800;        //vi tri text1
const int TEXT_1_Y = 20;
const int TEXT_2_X = 800;        //vi tri text2
const int TEXT_2_Y = 80;
const int TEXT_3_X = 600;         //vi tri text3
const int TEXT_3_Y = 30;
const int SCORE_X = 950;         //vi tri ghi diem
const int SCORE_Y = 20;
const int HIGH_SCORE_X = 950;    //vi tri diem cao nhat
