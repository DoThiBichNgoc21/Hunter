...
- [1. Cách tải game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#1-c%C3%A1ch-t%E1%BA%A3i-game)
  ...
  + [b) Bao gồm code và có thể biên dịch](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#b-bao-g%E1%BB%93m-code-v%C3%A0-c%C3%B3-th%E1%BB%83-bi%C3%AAn-d%E1%BB%8Bch)
       [Cài đặt thư viện SDL](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#c%C3%A0i-%C4%91%E1%BA%B7t-th%C6%B0-vi%E1%BB%87n-sdl)
       [Cài đặt và chạy game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#c%C3%A0i-%C4%91%E1%BA%B7t-v%C3%A0-ch%E1%BA%A1y-game)
- [2) Bắt đầu game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#2-b%E1%BA%AFt-%C4%91%E1%BA%A7u-game)
- [3) Các thành phần trong game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#3-c%C3%A1c-th%C3%A0nh-ph%E1%BA%A7n-trong-game)       
- [4) Cách chơi](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#3-c%C3%A1c-th%C3%A0nh-ph%E1%BA%A7n-trong-game)
  + [a) Chức năng của các đối tượng trong game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#a-ch%E1%BB%A9c-n%C4%83ng-c%E1%BB%A7a-c%C3%A1c-%C4%91%E1%BB%91i-t%C6%B0%E1%BB%A3ng-trong-game)
- [5) Kết thúc Game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#5-k%E1%BA%BFt-th%C3%BAc-game)
- [6) Các tính năng của Hunter Game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#6-c%C3%A1c-t%C3%ADnh-n%C4%83ng-c%E1%BB%A7a-hunter-game)
- [7) Hướng phát triển về sau](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#7-h%C6%B0%E1%BB%9Bng-ph%C3%A1t-tri%E1%BB%83n-v%E1%BB%81-sau)
- [Source Code Game](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#source-code-game)
- [Nguồn ảnh/icon](https://github.com/DoThiBichNgoc21/Hunter?tab=readme-ov-file#ngu%E1%BB%93n-%E1%BA%A3nhicon)     
...
- Chờ một chút cho đến khi cửa sổ Menu của game hiện ra.
  ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Screenshot%20(147).png)
  
- Nếu bạn chưa muốn chơi game luôn thì click chuột vào nút Exit, cửa sổ sẽ lập tức đóng lại.
- Để biết được cách chơi, bạn Click chuột vào nút Help, cửa sổ hướng dẫn sẽ hiện ra.
  ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Screenshot%20(148).png)
  
  + Sau khi đọc xong hướng dẫn, bạn Click vào nút ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Baccck1.png) để quay trở lại Menu.
...
- Ếch Hunter: là nhân vật chính trong game, Hunter sẽ luôn chạy còn bạn thì phải điều khiển hoạt động của Hunter để tránh các chướng ngại vật có trên đường.
  ...
  ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Ehhch.png)
  
- Quái (chướng ngại vật): Chúng sẽ xuất hiện random trên đường.
                                                              
![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/quai1.png)

![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/quai2.png)

![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/doii.png)
                
- Quả (hồi máu): Quả cũng sẽ xuất hiện random trên trời.

![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/Qua.png)
...
![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/da.png)

- Tia laze: Tia laze được bắn ra sẽ phá hủy được đá.

![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/Bullet/Bullet.png)

- Thanh máu: Cho biết sinh mạng của Hunter còn lại bao nhiêu.

  ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/HP.png)
...
- Điểm số hiện tại và điểm cao nhất: Dòng bên trên sẽ cho bạn biết điểm hiện tại của bạn còn dòng bên dưới sẽ cho bạn biết điểm cao nhất mà bạn từng đạt được.
  ...
  ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/KhungDiem.png)
- Nút tạm dừng/Tiếp tục: Khi bạn nhấn tạm dừng thì nút sẽ chuyển sang dạng
  ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Continnnue1.png), còn khi bạn nhấn tiếp tục thì nút chuyển sang dạng
 ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Pauccse1.png) .
- Bố cục trong game:

![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Screenshot%20(152).png)
...
|------|---------------|-----------|
| ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/quai1.png)    | Quái 1  | Va phải Quái sẽ làm giảm máu của Hunter |
| ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/quai2.png)    | Quái 2  | Va phải Quái sẽ làm giảm máu của Hunter |
| ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/doii.png)    | Quái 3  | Va phải Quái sẽ làm giảm máu của Hunter |
| ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/KeThu/Qua.png)      | Quả     | Ăn quả thì Hunter sẽ hồi máu            |
| ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/da.png)      | Đá      | Va phải đá Game sẽ kết thúc             |
| ![alt tag](https://github.com/DoThiBichNgoc21/Hunter/blob/master/img/review/Bullet.png)  | Laze    | Phá hủy Đá                              |
...
## Source Code Game
- Code tham khảo: https://github.com/thai-nm/dino-in-zungle
